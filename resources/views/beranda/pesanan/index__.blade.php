                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card" style="border-radius: 0px 0px 20px 20px;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{{ $item->nama_kantin }}</p>
                                <div class="d-flex justify-content-between mt-4">
                                    <div>
                                        <label for="porsi">Porsi:</label> 
                                        <input type="number" name="porsi" class="porsi" min="1" style="width: 40px; height: 25px;" disabled value="{{ $item->kuantitas }}">
                                    </div>
                                    <h5>{{ $item->harga }}</h5>
                                </div>
                            </div>
                            ...
                            @elseif($item->status == '2')
                                <div class="container card-footer py-3 bg-success" style="background-color: gray; border-radius: 0px 0px 20px 20px;">
                                    <p class="text-center text-light mb-2" style="position: relative; top: 20px;">Pesananmu sudah siap diambil. Pakai masker dan cuci tangan, ya</p>
                                    <div class="row gx-2 invisible">
                                        <div class="col order-0">
                                            <form action="">
                                                <button type="submit" class="btn btn-danger w-100">Batalkan</button>
